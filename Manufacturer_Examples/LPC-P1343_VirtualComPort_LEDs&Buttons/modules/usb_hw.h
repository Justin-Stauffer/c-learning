...
#define bmUSB_EP0Interrupt          0x00000002
#define bmUSB_EP1Interrupt          0x00000004
#define bmUSB_EP2Interrupt          0x00000008
#define bmUSB_EP3Interrupt          0x00000010
#define bmUSB_EP4Interrupt          0x00000020
#define bmUSB_DevStatusInterrupt    0x00000200
#define bmUSB_CommRegEmptyInterrupt 0x00000400
#define bmUSB_CommDataFullInterrupt 0x00000800
#define bmUSB_RxPacketInterrupt     0x00001000
#define bmUSB_TxPacketInterrupt     0x00002000
...
/*#define USBDEVINTST   USBDevIntSt
#define USBDEVINTEN   USBDevIntEn
#define USBDEVINTCLR  USBDevIntClr
#define USBDEVINTSET  USBDevIntSet
  USBDevFIQSel
  USBRxData
  USBTxData
  USBRxPLen
  USBTxPLen
  USBCtrl
#define USBCMDCODE  USBCmdCode
#define USBCMDDATA  USBCmdData
*/    
